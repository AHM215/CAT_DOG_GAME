...
def mainGame():
    ...
    global DOG_STATE, CAT_STATE, LOSE,ang
    ...
    ####################################### Health Bar
    # string = "CAT : " + str(CAT_RESULT)
    # draw_text(string, 120, WINDOW_HEIGHT - 50)
    # string = "DOG :  " + str(DOG_RESULT)
    # draw_text(string, 150, WINDOW_HEIGHT - 100)
    # string = "CURRENT TURN " + str(CURRENT_TURN)
    # draw_text(string, WINDOW_WIDTH // 2, WINDOW_HEIGHT - 50)
    # drawHealthBar("DOG")
    drawHealthBar("CAT")
    drawHealthBar("DOG")
    ###################################### Checking collision
    ...
    makeMsg()
    if CAT_RESULT <= 0 or DOG_RESULT <= 0:
        print(CAT_RESULT, DOG_RESULT)
        END = 1
        MAIN = 0
        START = 0
